...
def team_card_html(member):
    ...
    return panel_html(
        '<div style="display:flex; align-items:center; gap:14px;">'
        f'<div style="width:52px; height:52px; min-width:52px; border-radius:50%; '
        f'background:linear-gradient(135deg,{ACCENT},{METRIC_COLORS["purple"]}); '
        f"color:#FFFFFF; font-weight:700; font-size:1.05rem; display:flex; "
